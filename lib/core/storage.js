...
export default class Storage {
  ...
  setNative(key, value) {
    ...
    let data = {}
    const result = PersistentAccount.readAccount()
    if (result.data) {
      data = result.data
    }
    data[key] = value

    PersistentAccount.saveAccount({data: data})
  }
  ...
  removeNative(key) {
    ...
    PersistentAccount.saveAccount({ data: null });
  }
